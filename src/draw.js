...
【画风和色调硬性要求】
- 禁止：废墟、裂墙、碎瓦、荒废建筑、废土、破败场景、灰暗脏旧的环境
- 禁止：总是用油画风。画风要多样轮换——水彩、平涂、赛璐璐、清新插画、柔光、暖色系都可以
- 色调偏好：明亮、温暖、干净、通透为主。可以有傍晚/夜景但要有光感，不要灰蒙蒙脏兮兮
- 场景偏好：生活化、温馨、美好的地方（家、咖啡馆、公园、街道、海边、花田等），不是荒凉废弃之地
- 每次画风都要不一样，不能连续出相同风格`;
  const msgs=[
...
async function masterInspireFree(){
  const muses=[
    ...
    '水彩晕染——颜色边缘柔和渗透像记忆','柔和粉彩——像被阳光洗过的温柔',
    '赛璐璐动画感——干净的线条+大面积平涂色块','复古胶片色调——偏黄偏暖有年代感',
    '梦幻发光感——逆光/光晕/空气中漂浮微光','极简线条——大面积留白只勾两人轮廓',
    '清新透明水色——薄涂+透光+轻盈','暖色夕阳调——整体橙黄粉笼罩',
    '明亮动画插画风——饱和色彩+清晰轮廓+活泼','奶油色系——低饱和暖白+柔焦温柔感',
    // 特殊构图/视角
...
【画风和色调硬性要求】
- 禁止：废墟、裂墙、碎瓦、荒废建筑、废土、破败场景、灰暗脏旧的环境、水下城市、悬空废土
- 禁止：总是用油画风。画风要多样——水彩、平涂、赛璐璐、清新插画、柔光、暖色系都可以
- 色调偏好：明亮、温暖、干净、通透为主。可以有傍晚/夜景但要有光感和温度，不要灰蒙蒙
- 场景偏好：温馨美好的真实场所（家里、咖啡馆、公园、街道、花店、海边、草地等）
- 每次画风都要不一样，不能连续出相同风格`;
